...
class WeatherModel {
  ...
  factory WeatherModel.fromMap(Map<String, dynamic> map) {
    ...
    return WeatherModel(
      ...
      currentSky: currentWeatherData['weather'][0]['main']?.toDouble() ?? 0.0,
      currentPressure: currentWeatherData['main']['pressure']?.toDouble() ?? 0.0,
      currentWindSpeed: currentWeatherData['wind']['speed']?.toDouble() ?? 0.0,
      currentHumidity: currentWeatherData['main']['humidity']?.toDouble() ?? 0.0,
    );
  }
